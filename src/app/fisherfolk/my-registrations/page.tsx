  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="space-y-2 mb-8">
        <h1 className="text-3xl font-bold font-headline tracking-tight">My Registrations</h1>
      ...
      {myRegistrations.length === 0 ? (
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mt-1">You have not registered any vessels or gear yet.</p>
            <Button asChild className="mt-4">
              <Link href="/fisherfolk/register">Register Now</Link>
            </Button>
          </CardContent>
        </Card>
      ) : (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3">
                  <div className="p-6 md:col-span-2">
                    ...
                    <div className="mt-4 text-sm text-muted-foreground">
                      <p><strong>Registration Date:</strong> {reg.registrationDate}</p>
                      <p><strong>Expiry Date:</strong> {reg.expiryDate}</p>
                    </div>
                    ...
                    <div className="mt-6 flex gap-2">
                      ...
                      <Button variant="outline">
                        <FilePenLine className="mr-2 h-4 w-4" /> Update Details
                      </Button>
                    </div>
                  </div>
                  <div className="bg-muted p-6 flex flex-col items-center justify-center md:hidden">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">Scan QR Code</p>
                  </div>
                </div>
              </Card>
            )
