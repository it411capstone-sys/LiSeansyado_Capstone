...
export let registrations: Registration[] = [
  ...
  {
    id: 'REG-003',
    ownerId: 'user-crisostomo-ibarra',
...
export let payments: Payment[] = [
  ...
  },
  {
    ...
    referenceNumber: 'N/A',
    date: '2024-07-21',
    payerId: 'user-crisostomo-ibarra',
