...
export let registrations: Registration[] = [
  {
    ...
    avatarUrl: fisherfolk.find(f => f.email === 'maria.cruz@example.com')?.avatarUrl || '',
    email: 'maria.cruz@example.com',
  ...
  },
  {
    ...
    avatarUrl: fisherfolk.find(f => f.email === 'john.santos@example.com')?.avatarUrl || '',
    email: 'john.santos@example.com',
  ...
  },
  {
    ...
    avatarUrl: fisherfolk.find(f => f.email === 'carlos.pena@example.com')?.avatarUrl || '',
    email: 'carlos.pena@example.com',
  ...
  },
  {
    ...
    avatarUrl: fisherfolk.find(f => f.email === 'maria.clara@example.com')?.avatarUrl || '',
    email: 'maria.clara@example.com',
  ...
  },
  {
    ...
    avatarUrl: fisherfolk.find(f => f.email === 'c.ibarra@example.com')?.avatarUrl || '',
    email: 'c.ibarra@example.com',
  ...
  },
  {
    ...
    avatarUrl: fisherfolk.find(f => f.email === 'a.bonifacio@example.com')?.avatarUrl || '',
    email: 'a.bonifacio@example.com',
  ...
  },
  {
    ...
    avatarUrl: fisherfolk.find(f => f.email === 'g.silang@example.com')?.avatarUrl || '',
    email: 'g.silang@example.com',
    ...
    avatarUrl: fisherfolk.find(f => f.email === 'j.rizal@example.com')?.avatarUrl || '',
    email: 'j.rizal@example.com',
  ...
  },
  {
    ...
    avatarUrl: fisherfolk.find(f => f.email === 'e.aguinaldo@example.com')?.avatarUrl || '',
    email: 'e.aguinaldo@example.com',
