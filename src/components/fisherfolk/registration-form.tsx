    ...
    <div className="container mx-auto max-w-4xl p-4 md:p-8">
        <div className="space-y-2 mb-8">
            ...
            <p className="text-muted-foreground">
                {t("Step 1: Fill out your personal and registration details.")}
            </p>
        </div>
        <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <CardContent className="space-y-4">
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <Input placeholder={t("Enter owner's full name")} {...field} readOnly className="bg-muted"/>
                    </FormControl>
                    <FormMessage />
                    </FormItem>
                )}
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input type="email" placeholder={t("e.g., juan@email.com")} {...field} readOnly className="bg-muted"/>
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
